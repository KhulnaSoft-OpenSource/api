...
export class DbUser extends BaseEntity {
  ...
  @ApiModelProperty({
    description: "Flag indicating app.khulnasoft user status",
    example: false,
    default: false,
  })
  @Column({ default: false })
  public is_open_khulnasoft_member: boolean;
  ...
  @ApiModelProperty({
    ...
    example: "https://khulnasoft.com/blog",
  })
  @Column({
    type: "character varying",
    length: 255,
  ...
  @ApiModelProperty({
    ...
    example: "https://github.com/sponsors/khulnasoft-opensource",
  })
  @Column({
    type: "character varying",
    length: 255,
  ...
  @ApiModelProperty({
    ...
    example: "https://discord.gg/khulnasoft",
  })
  @Column({
    type: "character varying",
    length: 255,
