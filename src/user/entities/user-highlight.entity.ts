...
export class DbUserHighlight extends BaseEntity {
  ...
  @ApiModelProperty({
    ...
    example: "github.com/khulnasoft-opensource/insights/pull/1",
  })
  @Column("text")
  public url?: string;
  ...
  @ApiModelProperty({
    ...
    github.com/khulnasoft-opensource/insights/pull/1`,
  })
  @Column("text")
  ...
  @ApiModelProperty({
    ...
    example: ["khulnasoft-opensource/insights", "khulnasoft-opensource/ai"],
    type: "string",
    isArray: true,
  })
  @Column({
