...
export class DbRepo extends BaseEntity {
  ...
  @ApiModelProperty({
    ...
    example: "git://github.com/khulnasoft-opensource/insights.git",
  })
  @Column({
    type: "character varying",
    length: 255,
  ...
  @ApiModelProperty({
    ...
    example: "https://github.com/khulnasoft-opensource/insights.git",
  })
  @Column({
    type: "character varying",
    length: 255,
  ...
  @ApiModelProperty({
    ...
    example: "https://github.com/khulnasoft-opensource/insights",
  })
  @Column({
    type: "character varying",
    length: 255,
  ...
  @ApiModelProperty({
    ...
    example: "https://api.github.com/repos/khulnasoft-opensource/insights",
  })
  @Column({
    type: "character varying",
    length: 255,
  ...
  @ApiModelProperty({
    ...
    example: "https://app.khulnasoft.com",
  })
  @Column({
    type: "character varying",
    length: 255,
  ...
  @ApiModelProperty({
    ...
    example: ["khulnasoft-opensource", "open-source", "github"],
  })
  @Column({
    type: "varchar",
    array: true,
