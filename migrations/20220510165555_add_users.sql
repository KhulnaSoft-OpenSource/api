...
(
  ...
  is_open_khulnasoft_member boolean not null default false,
...
create index if not exists users_idx_is_open_khulnasoft_member on public.users (is_open_khulnasoft_member);
